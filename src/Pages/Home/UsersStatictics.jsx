...
const UsersStatictics = () => {
	...
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 lg:grid-cols-3">
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
            ...
            <CountUp end={250} duration="3" onStart={onStart} onEnd={onEnd} containerProps={containerProps} />
		...
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			...
			<div className="flex flex-col justify-center align-middle">
            <CountUp end={7500} duration="3" onStart={onStart} onEnd={onEnd} containerProps={containerProps} />
		...
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			...
			<div className="flex flex-col justify-center align-middle">
			<CountUp end={150000} duration="3" onStart={onStart} onEnd={onEnd} containerProps={containerProps} />
