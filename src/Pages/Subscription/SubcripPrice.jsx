	...
	<div className="container mx-auto">
		...
		<div className="grid gap-6 my-8 lg:grid-cols-3 ">
			<div className="flex flex-col p-8 space-y-4 rounded-md bg-gray-500">
                ...
                <p>You have to pay 5$ for 1minute package. After 1 month you will be normal user.</p>
			</div>
			<div className="flex flex-col p-8 space-y-4 rounded-md bg-gray-500">
                ...
                <p>You have to pay 12$ for 1minute package. After 5 month you will be normal user.</p>
			</div>
			<div className="flex flex-col p-8 space-y-4 rounded-md bg-gray-500">
                ...
                <p>You have to pay 15$ for 1 month package. After 10 month you will be normal user.</p>
			</div>
